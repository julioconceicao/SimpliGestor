    ...
    <>
      <TouchableOpacity onPress={toggleSwitch}>
        <View
          style={[
            styles.switch,
            isProfessional ? styles.switchProfessional : styles.switchClient,
          ]}
        >
          <View style={styles.switchInner}>
            <View
              style={[
                styles.switchToggle,
                isProfessional ? styles.switchToggleOn : styles.switchToggleOff,
              ]}
            >
      ...
      >
        <Text style={styles.textCadastro}>
          É novo por aqui ? Toque aqui para criar uma conta
        </Text>
      </TouchableOpacity>
    </>
  );
